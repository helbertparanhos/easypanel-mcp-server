...
Full tool descriptions with parameters are in [`llms.txt`](llms.txt). For the underlying tRPC API, see [`docs/easypanel-api.md`](docs/easypanel-api.md).

### `trpc_raw` — reach any of the ~347 procedures
